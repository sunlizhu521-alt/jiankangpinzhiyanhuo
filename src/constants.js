...
const QUALITY_SEAL_IMAGE = `${import.meta.env.BASE_URL}assets/quality-seal.svg`;
const DIMENSION_PREVIEW_ROW_LIMIT = 20;
const DEFAULT_ADMIN_USER = { id: 'u-admin', name: import.meta.env.VITE_ADMIN_NAME || '系统管理员', password: '', role: '管理员' };
...
const BUSINESS_DEPARTMENT_OPTIONS = ['事业部一', '事业部二', '其他'];
